              ...
              {myJobs.length === 0 ? (
                <div className="text-center py-12">
                  ...
                  <p className="text-zinc-400 mb-2">
                    Start building your dream team by posting your first opportunity
                  </p>
                  <p className="text-zinc-500 text-sm mb-6">
                    Perfect for startup roles, freelance projects, and contract work
                  </p>
                  <Link href="/jobs/post">
                ...
                <div className="space-y-4">
                  {myJobs.map((job) => (
                    <div
                      key={job._id}
                      className="p-4 bg-zinc-800/50 rounded-lg border border-zinc-700/50 hover:border-violet-500/50 transition-all duration-200 group"
                    >
              ...
              <div className="space-y-3 text-sm">
                <div className="p-3 bg-zinc-800/50 rounded-lg border border-zinc-700/30">
                  <p className="text-zinc-300">
                    <span className="text-violet-400">💡</span> Emphasize growth potential and
                    learning opportunities
                  </p>
                </div>
                <div className="p-3 bg-zinc-800/50 rounded-lg border border-zinc-700/30">
                  <p className="text-zinc-300">
                    <span className="text-emerald-400">💰</span> Consider equity compensation for
                    early employees
                  </p>
                </div>
                <div className="p-3 bg-zinc-800/50 rounded-lg border border-zinc-700/30">
                  <p className="text-zinc-300">
                    <span className="text-indigo-400">🎯</span> Highlight your mission and impact
                  </p>
                </div>
                <div className="p-3 bg-zinc-800/50 rounded-lg border border-zinc-700/30">
                  <p className="text-zinc-300">
                    <span className="text-amber-400">⚡</span> Move fast - top talent gets snapped
                    up quickly
                  </p>
                </div>
              </div>
