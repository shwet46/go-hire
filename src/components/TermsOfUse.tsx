      ...
      <div className="max-w-4xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
        ...
        <div className="prose prose-zinc prose-invert max-w-none">
          <section className="mb-8">
            ...
            <p>
              By accessing or using GoHire (&ldquo;we&rdquo;, &ldquo;our&rdquo;, &ldquo;us&rdquo;),
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6">
              <li>
                You may use GoHire only for lawful purposes and in accordance with these Terms.
              </li>
              <li>
                You agree not to use the platform to post or transmit any unlawful, harmful, or
                misleading content.
              </li>
              <li>
          ...
          <section className="mb-8">
            ...
            <p>
              All content, trademarks, logos, and intellectual property on GoHire are owned by us or
              our licensors. You may not use, copy, or distribute any content without our written
              permission.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6">
              ...
              <li>
                We are not responsible for the outcome of any job application or hiring process.
              </li>
            </ul>
          </section>
          ...
          <section className="mb-8">
            ...
            <p>
              GoHire is provided &ldquo;as is&rdquo; without warranties of any kind. We are not
          ...
          <section className="mb-8">
            ...
            <p>
              ...
              an updated &ldquo;Last updated&rdquo; date. Continued use of GoHire after changes
          ...
          <section className="mb-8">
            ...
            <ul className="list-none pl-0 mt-2">
              <li>
                <strong className="text-zinc-200">Email:</strong> support@gohire.com
              </li>
            </ul>
          </section>
        </div>
