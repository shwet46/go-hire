        ...
        <div className="relative md:max-w-xs w-full">
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <button className="appearance-none w-full min-w-[160px] max-w-xs px-4 py-3 pr-10 bg-zinc-800/50 border border-zinc-700 rounded-lg text-white text-left flex items-center justify-between focus:border-violet-500 focus:ring-2 focus:ring-violet-500/20 transition-all duration-200">
                <span>
                  {jobType
                    ? {
                        'full-time': 'Full-time',
            ...
            >
              ...
              <DropdownMenuItem onClick={() => setJobType('internship')}>
                Internship
              </DropdownMenuItem>
            </DropdownMenuContent>
          </DropdownMenu>
