      ...
      >
        {activeTab === "general" && (
          <div className="space-y-6 w-full">
            <div>
              <h2 className="text-xl font-bold mb-2 text-zinc-900 dark:text-zinc-100">General Settings</h2>
              <p className="text-zinc-600 dark:text-zinc-400 mb-6">Configure your basic preferences and account settings.</p>
            </div>
            
            <div className="bg-zinc-50 dark:bg-zinc-800/50 rounded-lg p-4 border border-zinc-200 dark:border-zinc-700">
              <h3 className="font-semibold text-zinc-900 dark:text-zinc-100 mb-2">Notifications</h3>
              <p className="text-sm text-zinc-600 dark:text-zinc-400 mb-4">Control how you receive updates</p>
              <div className="space-y-3">
                <label className="flex items-center">
                  <input type="checkbox" className="rounded border-zinc-300 dark:border-zinc-600" defaultChecked />
                  <span className="ml-2 text-sm text-zinc-700 dark:text-zinc-300">Email notifications</span>
                </label>
                <label className="flex items-center">
                  <input type="checkbox" className="rounded border-zinc-300 dark:border-zinc-600" />
                  <span className="ml-2 text-sm text-zinc-700 dark:text-zinc-300">Push notifications</span>
                </label>
              </div>
            </div>
            ...
            <div className="bg-zinc-50 dark:bg-zinc-800/50 rounded-lg p-4 border border-zinc-200 dark:border-zinc-700">
              ...
              <p className="text-sm text-zinc-600 dark:text-zinc-400 mb-4">Manage your privacy preferences</p>
        ...
        {activeTab === "appearance" && (
          <div className="space-y-6 w-full">
            <div>
              <h2 className="text-xl font-bold mb-2 text-zinc-900 dark:text-zinc-100">Appearance</h2>
              <p className="text-zinc-600 dark:text-zinc-400 mb-6">Customize the look and feel of your interface.</p>
            </div>
            ...
            <div className="bg-zinc-50 dark:bg-zinc-800/50 rounded-lg p-4 border border-zinc-200 dark:border-zinc-700">
              <div className="flex items-center justify-between mb-4">
                <div>
                  ...
                  <p className="text-sm text-zinc-600 dark:text-zinc-400">Choose between light and dark mode</p>
                </div>
                <button
              ...
              <div className="flex gap-4 mt-4">
                ...
                >
                  ...
                  <p className="text-sm font-medium text-center text-zinc-900 dark:text-zinc-100">Light</p>
                </div>
                ...
                >
                  ...
                  <p className="text-sm font-medium text-center text-zinc-900 dark:text-zinc-100">Dark</p>
                </div>
              </div>
            </div>

            <div className="bg-zinc-50 dark:bg-zinc-800/50 rounded-lg p-4 border border-zinc-200 dark:border-zinc-700">
              <h3 className="font-semibold text-zinc-900 dark:text-zinc-100 mb-2">Display Options</h3>
              <p className="text-sm text-zinc-600 dark:text-zinc-400 mb-4">Additional display customizations</p>
              <div className="space-y-3">
                ...
                <label className="flex items-center justify-between">
                  <span className="text-sm text-zinc-700 dark:text-zinc-300">Reduce animations</span>
                  <input type="checkbox" className="rounded border-zinc-300 dark:border-zinc-600" />
                </label>
              </div>
            </div>
