  ...
  const testimonials = [
    {
      ...
      content: "Found our lead developer and two interns within 2 weeks. The talent quality exceeded our expectations for early-stage hiring.",
      rating: 5,
    ...
    },
    {
      ...
      content: "The pre-vetted students saved us hours of screening. Hired 3 passionate interns who became full-time team members.",
      rating: 5,
      badge: "Team Builder",
      avatar: "KI",
    ...
    },
    {
      ...
      content: "Cost-effective hiring solution perfect for startups. The talent pool is genuinely motivated and skilled.",
      rating: 5,
      badge: "Budget Saver",
      avatar: "RS",
    ...
    },
    {
      ...
      role: "CS Student",
      company: "IIT Mumbai",
      content: "Got an amazing internship opportunity that turned into a founding team position. The platform connects real talent with real startups.",
      rating: 5,
        ...
        {testimonials.map((testimonial, index) => (
          ...
          >
            ...
            <div className="flex justify-between items-start mb-6">
              ...
              <div className={`bg-gradient-to-r ${testimonial.gradient} bg-opacity-20 text-transparent bg-clip-text px-3 py-1.5 rounded-full text-xs font-semibold border border-white/10 backdrop-blur-sm`}>
            ...
            <div className="flex items-center relative z-10">
              <div className={`w-12 h-12 rounded-xl bg-gradient-to-r ${testimonial.gradient} flex items-center justify-center text-white font-bold text-sm shadow-lg group-hover:scale-110 transition-transform duration-300`}>
                {testimonial.avatar}
              </div>
              <div className="ml-4">
            ...
            {/* Bottom accent line */}
            <div className={`absolute bottom-0 left-0 h-1 w-0 bg-gradient-to-r ${testimonial.gradient} group-hover:w-full transition-all duration-500 ease-out`}></div>
          </div>
        ))}
      </div>
          ...
          <div className="flex items-center gap-2">
            <div className="flex -space-x-2">
              {testimonials.slice(0, 3).map((t, i) => (
                <div key={i} className={`w-8 h-8 rounded-full bg-gradient-to-r ${t.gradient} border-2 border-neutral-900 flex items-center justify-center text-white text-xs font-semibold`}>
                  {t.avatar}
                </div>
              ))}
            </div>
