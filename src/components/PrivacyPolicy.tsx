      ...
      <div className="max-w-4xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
        ...
        <div className="prose prose-zinc prose-invert max-w-none">
          <section className="mb-8">
            ...
            <p>
              Welcome to GoHire (&ldquo;we&rdquo;, &ldquo;our&rdquo;, or &ldquo;us&rdquo;). We
              respect your privacy and are committed to protecting your personal data. This Privacy
              Policy explains how we collect, use, disclose, and safeguard your information when you
              use our job portal platform and services.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 mb-4">
              <li className="mb-2">
                <strong className="text-zinc-200">Email Address</strong>: Used for account
                authentication, communication, and account recovery.
              </li>
              <li className="mb-2">
                <strong className="text-zinc-200">Profile Information</strong>: Such as your name,
                resume, skills, education, and work experience (for job seekers), or company details
                (for recruiters).
              </li>
            </ul>
            ...
            <p className="mt-2">
              This information helps us improve our platform and provide a better user experience.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6">
              ...
              <li>
                Sending periodic emails regarding jobs, applications, or platform updates (if you
                opt-in)
              </li>
